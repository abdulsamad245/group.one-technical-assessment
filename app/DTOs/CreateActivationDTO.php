...
class CreateActivationDTO
{
    ...
    public function setInstanceType(string $instance_type): self
    {
    ...
    public function setInstanceValue(string $instance_value): self
    {
    ...
    public function getInstanceValue(): string
    {
